...
@section('content')
    ...
    <div class="flex flex-row  bg-gray-100 text-gray-500 rounded-3xl shadow-xl p-10 mx-10 lg:mx-40">

        <div class="w-0 hidden md:w-1/2 md:inline-block bg-indigo-500 mr-10 rounded-3xl shadow-xl p-2">
        ...
        <div class="w-full md:w-1/2">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class='flex flex-col self-center space-y-10'>

                    <div class="text-center">
                        <h6 class="text-xs font-extrabold text-red-500">Finance Registry Version 1.0.0.0 </h6>
                        <h1 class="font-bold text-3xl text-gray-900">Login</h1>
                        <p>Enter your details to start your session</p>
                    </div>
                    ...
                    <div>
                        <label for="email" class="text-sm font-semibold px-1">Email address</label>

                        <input id="email" name='email' type="email" value="{{ old('email') }}" required autofocus class="w-full pl-5 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('email') is-invalid @enderror" >
                    </div>

                    <div>
                        <label for="password" class="text-sm font-semibold px-1">Password</label>

                        <input id="password" name='password' type="password" required class="w-full pl-5 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500 @error('password') is-invalid @enderror">
                    </div>
                    <div class="flex -mx-3">
