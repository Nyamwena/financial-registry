    ...
    <div class="grid grid-cols-2 gap-6 mt-5">
        ...
        <div class="modal" id="edit_payment_plan">
            <div class="modal__content">
                ...
                <form action="{{route('payment-plan.approve-store')}}" id="form-payment_plan" method="post">
                    @csrf
                    <div class="">
                        <div class="grid grid-cols-12 gap-4 row-gap-5 mt-5">
                            ...
                            <div class="intro-y col-span-6 sm:col-span-4">
                                ...
                                <input type="hidden" class="input w-full border flex-1" placeholder="0" id="recommend_id"  name="approve_id" required>
